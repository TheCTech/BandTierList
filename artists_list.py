...
BANDS = [
    ...
    "The Pretty Reckless", "The Plot in You", "Skindred", "President", "Royal Republic",
    "Catch Your Breath", "Six Feet Under", "Magnolia Park", "Just Mustard",
    "Thrown", "Annisokay", "Quicksand", "Melrose Avenue", "TX2",
    "The Pretty Wild", "Zascha", "Pure Chlorine",

    "Iron Maiden", "Sabaton", "Alter Bridge", "A Day to Remember", "Sepultura",
    ...
    "All Them Witches", "Malevolence", "The Funeral Portrait",
    "Drain", "Slay Squad", "Vinegar Hill", "Purple"
]